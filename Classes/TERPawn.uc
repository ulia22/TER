...
//	NotifyTeamChanged();
//	local TERPlayerController TERPC;
//
//	if(C.IsA('TERPlayerController'))  // Selection for players
//	{
//		TERPC=LePlayerController(C);  // C est le controller recu en parametre
//		LePC.energieCourante=energie;  // on fourni la valeur d'energie
//		LePC.energieMax=energieMax; //on fourni la limite max
//	}
//}
